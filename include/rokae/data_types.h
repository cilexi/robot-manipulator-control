...
// *********************           枚举类             **********************
 ...
 namespace RtSupportedFields {
  ...
  constexpr const char *jointAcc_m = "ddq_m"; ///< 关节加速度 [rad/s^2] - ArrayXD
  ...
  constexpr const char *tcpVel_m   = "pos_vel_m"; ///< 机器人末端速度 - Array6D
  constexpr const char *tcpVel_c   = "pos_vel_c"; ///< 指令机器人末端速度 - Array6D
  constexpr const char *tcpAcc_m   = "pos_acc_m"; ///< 机器人末端加速度 - Array6D
